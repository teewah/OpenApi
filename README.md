# MFISA OpenAPI Specification
[![Build Status](https://travis-ci.org/teewah/OpenApi.svg?branch=master)](https://travis-ci.org/teewah/OpenApi)
...
6. If you did everything correct, https://teewah.github.io/OpenApi/ will lead to your new docs
...
- Documentation(ReDoc): https://teewah.github.io/OpenApi/
- SwaggerUI: https://teewah.github.io/OpenApi/swagger-ui/
- Look full spec:
    + JSON https://teewah.github.io/OpenApi/swagger.json
    + YAML https://teewah.github.io/OpenApi/swagger.yaml
- Preview spec version for branch `[branch]`: https://teewah.github.io/OpenApi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://teewah.github.io/OpenApi/ with url from the message: `Server started <url>`
